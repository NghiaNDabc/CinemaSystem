...
public class Movie implements Serializable {
    ...
    public Movie(int id_Movie, int id_Genre, String movieName, Date releasedDate, String country, Time duration, String director, String language, Integer censorship, Float version, Float price, String descripsion,String image) {
        Id_Movie = id_Movie;
        Id_Genre = id_Genre;
        MovieName = movieName;
